...
# Rebuild EmailService with Fixed Dockerfile
# This script rebuilds the emailservice using a simplified Dockerfile
...
DOCKERFILE_PATH="src/emailservice/Dockerfile.fixed"
