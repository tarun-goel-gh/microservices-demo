...
# Rebuild EmailService with Multi-Architecture Support
# This script rebuilds the emailservice for both AMD64 and ARM64 architectures
...
# Main execution
main() {
    print_status "Starting multi-architecture build for $SERVICE_NAME..."
    ...
    print_status "Building $SERVICE_NAME for multiple architectures..."
